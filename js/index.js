...
$("body").on("click", ".musicbox .icon-change", function() {
    $(this).html() == "切换男版" ? [$(this).next().children("audio").attr("src", "mp3/song-man.mp3"), $(this).html("切换女版"), $(this).prev().html("演唱：黄放")] : [$(this).next().children("audio").attr("src", "mp3/song.mp3"), $(this).html("切换男版"), $(this).prev().html("演唱：戴秋平")];
